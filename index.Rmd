...
Next, we count the frequency of words used in each narrative reporting category. Then, we select the top 15 most frequent words for each category for further analysis.
...
wordcloud2(theme_data, size = 1, minSize = 5, color = "random-light")
```
